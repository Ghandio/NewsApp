...
import com.androiddevs.newsApp.adapters.NewsAdappter
...
class BreakingNewsFragment :Fragment(R.layout.fragment_breaking_news){
    ...
    lateinit var newsAdapter : NewsAdappter
    ...
    private fun setupRecyclerView(){
        newsAdapter= NewsAdappter()
        rvBreakingNews.apply { adapter=newsAdapter
